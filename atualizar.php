...
<head>
	...
	<title>Atualização de Cadastros</title>
	<meta charset="utf-8">
...
<form method="POST" action="atualizar2.php">
  ...
  <div class="m-3">
   ...
   <div class="m-3">
    ...
    <input type="date" class="form-control w-50" id="exampleInputEmail1" aria-describedby="emailHelp" name="data_calibracao"  placeholder="" value="<?php print $consulta['data_calibracao']; ?>">
    <div id="emailHelp" class="form-text"></div>
  </div>
  ...
  <option value="Não disponível para Calibração">Não disponível para Calibração</option>
  <option value="Disponível para Calibração">Disponível para Calibração</option>
  <option value="Manutenção">Manutenção</option>
  <option value="Reprovado">Reprovado</option>
  <option value="Equipamento Precisa Calibrar">Equipamento Precisa Calibrar</option>
</select>
</div>

  <button type="submit" class="btn btn-primary m-3 cor">Editar</button>
</form>
